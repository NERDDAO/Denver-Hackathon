...
#### Fund access constraints[​](#fund-access-constraints "Direct link to Fund access constraints")
...
[Edit this page](https://github.com/jbx-protocol/juice-docs/blob/main/docs/dev/build/programmable-treasury.md)
